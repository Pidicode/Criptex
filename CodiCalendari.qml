...
PageClassica {
    ...
    ColumnCifrados{
        ...
        tDescripccion.text:"El mètode calendari es un mètode de substitució força curiós i diferent. Consisteix en la utilització d'un calendari i dels seus dies del mes per realitzar el xifrat. El desxifrat al programa encara no funciona. Per conèixer el funcionament del xifrat fes click <a href='http://www.kde.org'>aquí</a> "
